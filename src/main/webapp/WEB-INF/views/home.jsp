...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide home-image" src="<c:url value="/resources/images/carousel3.png"/> " alt="First slide">
            <div class="container">
        ...
        <div class="item">
            <img class="third-slide" home-image src="<c:url value="/resources/images/carousel1.png"/>" alt="Third slide">
            <div class="container">
                <div class="carousel-caption">
